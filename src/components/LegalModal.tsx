        ...
        <div className="p-6 space-y-4 max-h-[70vh] overflow-y-auto text-xs text-slate-700 dark:text-slate-300 leading-relaxed font-sans">
          ...
          {type === 'terms' && (
            <>
              ...
              <p>CV PILOT offers a Basic Free Plan (1 CV limit) and a Pro Membership subscription priced at <strong>LKR 2,000 / month</strong> (approx $10.00 USD). By subscribing to Pro, you authorize monthly recurring billing to your selected payment method until cancelled.</p>
          ...
          {type === 'refund' && (
            <>
              ...
              <p>You can cancel your Pro Membership (LKR 2,000/month or approx $10.00 USD) at any time through your account settings or by contacting support. Upon cancellation, your subscription will remain active until the end of your current billing period.</p>
